...
export default function EditContributionModal() {
  ...
  const contributionId = Array.isArray(params.id)
    ? params.id[0]
    : params.id;
  ...
  const contribution = useMemo(() => {
    ...
    return allContributions.find(
      (c: Contribution) => c.id === contributionId,
    );
    ...
    return (
      ...
      >
        <View style={styles.center}>
          ...
          <Text style={styles.subtitle}>
            This contribution may have been deleted,
  ...
  const handleSave = async () => {
    ...
    try {
      await updateContributionAndSync(
        contribution.id,
        {
          amount: parsedAmount,
          date,
      ...
      show(
        "Contribution updated — wallet record synced",
      );
  ...
  const handleDelete = () => {
    ...
    const message =
      "This will permanently delete this rejected contribution. The deletion will be recorded in the audit history. This action cannot be undone.";
      ...
      >
        ...
        {contribution.status === "approved" && (
          <View style={styles.noticeBox}>
            ...
            <Text style={styles.noticeText}>
              This contribution is approved and has
              a matching wallet transaction. Saving
              here will update both records together.
            </Text>
          </View>
        )}
        ...
        {isRejected && (
          <View style={styles.rejectedBox}>
            ...
            <Text style={styles.rejectedText}>
              This contribution was rejected. You
              can edit it or permanently delete it.
            </Text>
        ...
        {isRejected && (
          <>
            ...
            <Button
              label="Delete Rejected Contribution"
